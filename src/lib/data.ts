...
import { scrapItems } from './data/sucata';
import { tubosOdItems } from './data/tubos-od';
import { tubosAliancaItems } from './data/tubos-alianca';
import { connectionsGroups } from './data/conexoes';
import { chapasItems } from './data/chapas';
import { bronzeRodsItems } from './data/tarugo-bronze';
import { aluminumRodsItems } from './data/verg-aluminio';
import { chapasAluminioItems } from './data/chapas-aluminio';
import { brassRodsItems } from './data/verg-latao';
import { barrasRedondasItems } from './data/barras-redondas';
import { barrasQuadradasItems } from './data/barras-quadradas';
import { barrasSextavadasItems } from './data/barras-sextavadas';
import { tubosScheduleItems } from './data/tubos-schedule';
import { cantoneirasItems } from './data/cantoneiras';
import { barrasChatasItems } from './data/barras-chatas';
import { metalonQuadradoItems } from './data/metalon-quadrado';
import { metalonRetangularItems } from './data/metalon-retangular';
