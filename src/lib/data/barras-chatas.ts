...
export const barrasChatasItems: SteelItem[] = [
        ...
        { id: 'bc-1-5/16', unit: 'm', description: 'Barra Chata 1" x 5/16" (25.40x7.94mm)', weight: calculateFlatBarWeight(25.40, 7.94), categoryName: 'barras-chatas' },
        { id: 'bc-1-3/8', unit: 'm', description: 'Barra Chata 1" x 3/8" (25.40x9.52mm)', weight: calculateFlatBarWeight(25.40, 9.52), categoryName: 'barras-chatas' },
        ...
        { id: 'bc-1-5/8', unit: 'm', description: 'Barra Chata 1" x 5/8" (25.40x15.88mm)', weight: calculateFlatBarWeight(25.40, 15.88), categoryName: 'barras-chatas' },
