...
const ALL_CATEGORIES: Category[] = [
  ...
  {
    id: 'informativos/normas-astm',
    name: 'Normas ASTM',
    description: 'Guia de normas técnicas para aço inoxidável.',
    icon: 'Book',
    unit: 'calc',
    items: [],
    path: '/informativos/normas-astm',
  },
  {
    id: 'informativos/processos-fabricacao',
    name: 'Processos',
    description: 'Processos de produção e trabalho com aço inoxidável.',
    icon: 'Factory',
    unit: 'calc',
    items: [],
    path: '/informativos/processos-fabricacao',
  },
  {
    id: 'informativos/desenho-tecnico',
    name: 'Desenho Técnico',
    description: 'Guia de leitura e interpretação de desenhos.',
    icon: 'DraftingCompass',
    unit: 'calc',
    items: [],
    path: '/informativos/desenho-tecnico',
  },
   {
    id: 'gauge',
