...
const tubosAliancaItems: SteelItem[] = [
  { id: 'ta-21.3-2.00', description: 'Tubo DIN 21,30mm x 2.00mm (DI 17,30mm)', weight: (21.30 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-21.3-2.35', description: 'Tubo DIN 21,30mm x 2.35mm (DI 16,60mm)', weight: (21.30 - 2.35) * 2.35 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-26.9-2.00', description: 'Tubo DIN 26,90mm x 2.00mm (DI 22,90mm)', weight: (26.90 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-26.9-2.35', description: 'Tubo DIN 26,90mm x 2.35mm (DI 22,20mm)', weight: (26.90 - 2.35) * 2.35 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-33.7-2.00', description: 'Tubo DIN 33,70mm x 2.00mm (DI 29,70mm)', weight: (33.70 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-33.7-2.65', description: 'Tubo DIN 33,70mm x 2.65mm (DI 28,40mm)', weight: (33.70 - 2.65) * 2.65 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-33.7-3.00', description: 'Tubo DIN 33,70mm x 3.00mm (DI 27,70mm)', weight: (33.70 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-42.4-2.00', description: 'Tubo DIN 42,40mm x 2.00mm (DI 38,40mm)', weight: (42.40 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-42.4-2.65', description: 'Tubo DIN 42,40mm x 2.65mm (DI 37,10mm)', weight: (42.40 - 2.65) * 2.65 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-42.4-3.00', description: 'Tubo DIN 42,40mm x 3.00mm (DI 36,40mm)', weight: (42.40 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-48.3-2.00', description: 'Tubo DIN 48,30mm x 2.00mm (DI 44,30mm)', weight: (48.30 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-48.3-2.65', description: 'Tubo DIN 48,30mm x 2.65mm (DI 43,00mm)', weight: (48.30 - 2.65) * 2.65 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-48.3-3.00', description: 'Tubo DIN 48,30mm x 3.00mm (DI 42,30mm)', weight: (48.30 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-60.3-2.00', description: 'Tubo DIN 60,30mm x 2.00mm (DI 56,30mm)', weight: (60.30 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-60.3-2.65', description: 'Tubo DIN 60,30mm x 2.65mm (DI 55,00mm)', weight: (60.30 - 2.65) * 2.65 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-60.3-3.00', description: 'Tubo DIN 60,30mm x 3.00mm (DI 54,30mm)', weight: (60.30 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-76.1-2.00', description: 'Tubo DIN 76,10mm x 2.00mm (DI 72,10mm)', weight: (76.10 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-76.1-3.00', description: 'Tubo DIN 76,10mm x 3.00mm (DI 70,10mm)', weight: (76.10 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-88.9-2.00', description: 'Tubo DIN 88,90mm x 2.00mm (DI 84,90mm)', weight: (88.90 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-88.9-3.00', description: 'Tubo DIN 88,90mm x 3.00mm (DI 82,90mm)', weight: (88.90 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-101.6-2.00', description: 'Tubo DIN 101,60mm x 2.00mm (DI 97,60mm)', weight: (101.60 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-101.6-3.00', description: 'Tubo DIN 101,60mm x 3.00mm (DI 95,60mm)', weight: (101.60 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
  { id: 'ta-114.3-3.00', description: 'Tubo DIN 114,30mm x 3.00mm (DI 108,30mm)', weight: (114.30 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Aliança' },
];
...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    unit: 'm',
    items: [
        { id: 't-3/8-0.70', description: 'Tubo OD 3/8" (9.52mm) x 0.70mm (DI 8.12mm)', weight: (9.52 - 0.70) * 0.70 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-3/8-1.00', description: 'Tubo OD 3/8" (9.52mm) x 1.00mm (DI 7.52mm)', weight: (9.52 - 1.00) * 1.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-3/8-1.20', description: 'Tubo OD 3/8" (9.52mm) x 1.20mm (DI 7.12mm)', weight: (9.52 - 1.20) * 1.20 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-3/8-1.50', description: 'Tubo OD 3/8" (9.52mm) x 1.50mm (DI 6.52mm)', weight: (9.52 - 1.50) * 1.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1/2-1.00', description: 'Tubo OD 1/2" (12.70mm) x 1.00mm (DI 10.70mm)', weight: (12.70 - 1.00) * 1.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1/2-1.20', description: 'Tubo OD 1/2" (12.70mm) x 1.20mm (DI 10.30mm)', weight: (12.70 - 1.20) * 1.20 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1/2-1.50', description: 'Tubo OD 1/2" (12.70mm) x 1.50mm (DI 9.70mm)', weight: (12.70 - 1.50) * 1.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-5/8-1.00', description: 'Tubo OD 5/8" (15.88mm) x 1.00mm (DI 13.88mm)', weight: (15.88 - 1.00) * 1.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-5/8-1.20', description: 'Tubo OD 5/8" (15.88mm) x 1.20mm (DI 13.48mm)', weight: (15.88 - 1.20) * 1.20 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-5/8-1.50', description: 'Tubo OD 5/8" (15.88mm) x 1.50mm (DI 12.88mm)', weight: (15.88 - 1.50) * 1.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-3/4-1.00', description: 'Tubo OD 3/4" (19.05mm) x 1.00mm (DI 17.05mm)', weight: (19.05 - 1.00) * 1.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-3/4-1.20', description: 'Tubo OD 3/4" (19.05mm) x 1.20mm (DI 16.65mm)', weight: (19.05 - 1.20) * 1.20 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-3/4-1.50', description: 'Tubo OD 3/4" (19.05mm) x 1.50mm (DI 16.05mm)', weight: (19.05 - 1.50) * 1.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1-1.00', description: 'Tubo OD 1" (25.40mm) x 1.00mm (DI 23.40mm)', weight: (25.40 - 1.00) * 1.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1-1.20', description: 'Tubo OD 1" (25.40mm) x 1.20mm (DI 23.00mm)', weight: (25.40 - 1.20) * 1.20 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1-1.50', description: 'Tubo OD 1" (25.40mm) x 1.50mm (DI 22.40mm)', weight: (25.40 - 1.50) * 1.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1-2.00', description: 'Tubo OD 1" (25.40mm) x 2.00mm (DI 21.40mm)', weight: (25.40 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1-2.50', description: 'Tubo OD 1" (25.40mm) x 2.50mm (DI 20.40mm)', weight: (25.40 - 2.50) * 2.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1-3.00', description: 'Tubo OD 1" (25.40mm) x 3.00mm (DI 19.40mm)', weight: (25.40 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/4-1.00', description: 'Tubo OD 1.1/4" (31.75mm) x 1.00mm (DI 29.75mm)', weight: (31.75 - 1.00) * 1.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/4-1.20', description: 'Tubo OD 1.1/4" (31.75mm) x 1.20mm (DI 29.35mm)', weight: (31.75 - 1.20) * 1.20 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/4-1.50', description: 'Tubo OD 1.1/4" (31.75mm) x 1.50mm (DI 28.75mm)', weight: (31.75 - 1.50) * 1.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/4-2.00', description: 'Tubo OD 1.1/4" (31.75mm) x 2.00mm (DI 27.75mm)', weight: (31.75 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/4-2.50', description: 'Tubo OD 1.1/4" (31.75mm) x 2.50mm (DI 26.75mm)', weight: (31.75 - 2.50) * 2.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/4-3.00', description: 'Tubo OD 1.1/4" (31.75mm) x 3.00mm (DI 25.75mm)', weight: (31.75 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/2-1.00', description: 'Tubo OD 1.1/2" (38.10mm) x 1.00mm (DI 36.10mm)', weight: (38.10 - 1.00) * 1.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/2-1.20', description: 'Tubo OD 1.1/2" (38.10mm) x 1.20mm (DI 35.70mm)', weight: (38.10 - 1.20) * 1.20 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/2-1.50', description: 'Tubo OD 1.1/2" (38.10mm) x 1.50mm (DI 35.10mm)', weight: (38.10 - 1.50) * 1.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/2-2.00', description: 'Tubo OD 1.1/2" (38.10mm) x 2.00mm (DI 34.10mm)', weight: (38.10 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/2-2.50', description: 'Tubo OD 1.1/2" (38.10mm) x 2.50mm (DI 33.10mm)', weight: (38.10 - 2.50) * 2.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-1_1/2-3.00', description: 'Tubo OD 1.1/2" (38.10mm) x 3.00mm (DI 32.10mm)', weight: (38.10 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-2-1.00', description: 'Tubo OD 2" (50.80mm) x 1.00mm (DI 48.80mm)', weight: (50.80 - 1.00) * 1.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-2-1.20', description: 'Tubo OD 2" (50.80mm) x 1.20mm (DI 48.40mm)', weight: (50.80 - 1.20) * 1.20 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-2-1.50', description: 'Tubo OD 2" (50.80mm) x 1.50mm (DI 47.80mm)', weight: (50.80 - 1.50) * 1.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-2-2.00', description: 'Tubo OD 2" (50.80mm) x 2.00mm (DI 46.80mm)', weight: (50.80 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-2-2.50', description: 'Tubo OD 2" (50.80mm) x 2.50mm (DI 45.80mm)', weight: (50.80 - 2.50) * 2.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-2-3.00', description: 'Tubo OD 2" (50.80mm) x 3.00mm (DI 44.80mm)', weight: (50.80 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-2_1/2-1.20', description: 'Tubo OD 2.1/2" (63.50mm) x 1.20mm (DI 61.10mm)', weight: (63.50 - 1.20) * 1.20 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-2_1/2-1.50', description: 'Tubo OD 2.1/2" (63.50mm) x 1.50mm (DI 60.50mm)', weight: (63.50 - 1.50) * 1.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-2_1/2-2.00', description: 'Tubo OD 2.1/2" (63.50mm) x 2.00mm (DI 59.50mm)', weight: (63.50 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-2_1/2-3.00', description: 'Tubo OD 2.1/2" (63.50mm) x 3.00mm (DI 57.50mm)', weight: (63.50 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-3-1.20', description: 'Tubo OD 3" (76.20mm) x 1.20mm (DI 73.80mm)', weight: (76.20 - 1.20) * 1.20 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-3-1.50', description: 'Tubo OD 3" (76.20mm) x 1.50mm (DI 73.20mm)', weight: (76.20 - 1.50) * 1.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-3-2.00', description: 'Tubo OD 3" (76.20mm) x 2.00mm (DI 72.20mm)', weight: (76.20 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-3-3.00', description: 'Tubo OD 3" (76.20mm) x 3.00mm (DI 70.20mm)', weight: (76.20 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-4-1.50', description: 'Tubo OD 4" (101.60mm) x 1.50mm (DI 98.60mm)', weight: (101.60 - 1.50) * 1.50 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-4-2.00', description: 'Tubo OD 4" (101.60mm) x 2.00mm (DI 97.60mm)', weight: (101.60 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-4-3.00', description: 'Tubo OD 4" (101.60mm) x 3.00mm (DI 95.60mm)', weight: (101.60 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-5-2.00', description: 'Tubo OD 5" (127.00mm) x 2.00mm (DI 123.00mm)', weight: (127.00 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-5-3.00', description: 'Tubo OD 5" (127.00mm) x 3.00mm (DI 121.00mm)', weight: (127.00 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-6-2.00', description: 'Tubo OD 6" (152.40mm) x 2.00mm (DI 148.40mm)', weight: (152.40 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-6-3.00', description: 'Tubo OD 6" (152.40mm) x 3.00mm (DI 146.40mm)', weight: (152.40 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-8-2.00', description: 'Tubo OD 8" (203.20mm) x 2.00mm (DI 199.20mm)', weight: (203.20 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-8-3.00', description: 'Tubo OD 8" (203.20mm) x 3.00mm (DI 197.20mm)', weight: (203.20 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-10-2.00', description: 'Tubo OD 10" (254.00mm) x 2.00mm (DI 250.00mm)', weight: (254.00 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-10-3.00', description: 'Tubo OD 10" (254.00mm) x 3.00mm (DI 248.00mm)', weight: (254.00 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-12-2.00', description: 'Tubo OD 12" (304.80mm) x 2.00mm (DI 300.80mm)', weight: (304.80 - 2.00) * 2.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
        { id: 't-12-3.00', description: 'Tubo OD 12" (304.80mm) x 3.00mm (DI 298.80mm)', weight: (304.80 - 3.00) * 3.00 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo OD' },
    ],
  },
  {
    id: 'tubos-alianca',
  ...
  },
  {
    ...
    unit: 'm',
    items: [
      { id: 'ts-3/8-sch5', description: 'Tubo Schedule 3/8" SCH 5 (17.14mm x 1.65mm) (DI 13.84mm)', weight: (17.14 - 1.65) * 1.65 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-3/8-sch10', description: 'Tubo Schedule 3/8" SCH 10 (17.14mm x 2.31mm) (DI 12.52mm)', weight: (17.14 - 2.31) * 2.31 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-3/8-sch40', description: 'Tubo Schedule 3/8" SCH 40 (17.14mm x 3.20mm) (DI 10.74mm)', weight: (17.14 - 3.20) * 3.20 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1/2-sch5', description: 'Tubo Schedule 1/2" SCH 5 (21.34mm x 1.65mm) (DI 18.04mm)', weight: (21.34 - 1.65) * 1.65 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1/2-sch10', description: 'Tubo Schedule 1/2" SCH 10 (21.34mm x 2.11mm) (DI 17.12mm)', weight: (21.34 - 2.11) * 2.11 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1/2-sch40', description: 'Tubo Schedule 1/2" SCH 40 (21.34mm x 2.77mm) (DI 15.80mm)', weight: (21.34 - 2.77) * 2.77 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-3/4-sch5', description: 'Tubo Schedule 3/4" SCH 5 (26.67mm x 1.65mm) (DI 23.37mm)', weight: (26.67 - 1.65) * 1.65 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-3/4-sch10', description: 'Tubo Schedule 3/4" SCH 10 (26.67mm x 2.11mm) (DI 22.45mm)', weight: (26.67 - 2.11) * 2.11 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-3/4-sch40', description: 'Tubo Schedule 3/4" SCH 40 (26.67mm x 2.87mm) (DI 20.93mm)', weight: (26.67 - 2.87) * 2.87 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1-sch5', description: 'Tubo Schedule 1" SCH 5 (33.40mm x 1.65mm) (DI 30.10mm)', weight: (33.40 - 1.65) * 1.65 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1-sch10', description: 'Tubo Schedule 1" SCH 10 (33.40mm x 2.77mm) (DI 27.86mm)', weight: (33.40 - 2.77) * 2.77 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1-sch40', description: 'Tubo Schedule 1" SCH 40 (33.40mm x 3.38mm) (DI 26.64mm)', weight: (33.40 - 3.38) * 3.38 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1_1/4-sch5', description: 'Tubo Schedule 1 1/4" SCH 5 (42.16mm x 1.65mm) (DI 38.86mm)', weight: (42.16 - 1.65) * 1.65 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1_1/4-sch10', description: 'Tubo Schedule 1 1/4" SCH 10 (42.16mm x 2.77mm) (DI 36.62mm)', weight: (42.16 - 2.77) * 2.77 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1_1/4-sch40', description: 'Tubo Schedule 1 1/4" SCH 40 (42.16mm x 3.56mm) (DI 35.04mm)', weight: (42.16 - 3.56) * 3.56 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1_1/2-sch5', description: 'Tubo Schedule 1 1/2" SCH 5 (48.26mm x 1.65mm) (DI 44.96mm)', weight: (48.26 - 1.65) * 1.65 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1_1/2-sch10', description: 'Tubo Schedule 1 1/2" SCH 10 (48.26mm x 2.77mm) (DI 42.72mm)', weight: (48.26 - 2.77) * 2.77 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-1_1/2-sch40', description: 'Tubo Schedule 1 1/2" SCH 40 (48.26mm x 3.68mm) (DI 40.90mm)', weight: (48.26 - 3.68) * 3.68 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-2-sch5', description: 'Tubo Schedule 2" SCH 5 (60.33mm x 1.65mm) (DI 57.03mm)', weight: (60.33 - 1.65) * 1.65 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-2-sch10', description: 'Tubo Schedule 2" SCH 10 (60.33mm x 2.77mm) (DI 54.79mm)', weight: (60.33 - 2.77) * 2.77 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-2-sch40', description: 'Tubo Schedule 2" SCH 40 (60.33mm x 3.91mm) (DI 52.51mm)', weight: (60.33 - 3.91) * 3.91 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-2_1/2-sch5', description: 'Tubo Schedule 2 1/2" SCH 5 (73.03mm x 2.11mm) (DI 68.81mm)', weight: (73.03 - 2.11) * 2.11 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-2_1/2-sch10', description: 'Tubo Schedule 2 1/2" SCH 10 (73.03mm x 3.05mm) (DI 66.93mm)', weight: (73.03 - 3.05) * 3.05 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-2_1/2-sch40', description: 'Tubo Schedule 2 1/2" SCH 40 (73.03mm x 5.16mm) (DI 62.71mm)', weight: (73.03 - 5.16) * 5.16 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-3-sch5', description: 'Tubo Schedule 3" SCH 5 (88.90mm x 2.11mm) (DI 84.68mm)', weight: (88.90 - 2.11) * 2.11 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-3-sch10', description: 'Tubo Schedule 3" SCH 10 (88.90mm x 3.05mm) (DI 82.80mm)', weight: (88.90 - 3.05) * 3.05 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-3-sch40', description: 'Tubo Schedule 3" SCH 40 (88.90mm x 5.49mm) (DI 77.92mm)', weight: (88.90 - 5.49) * 5.49 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-4-sch5', description: 'Tubo Schedule 4" SCH 5 (114.30mm x 2.11mm) (DI 110.08mm)', weight: (114.30 - 2.11) * 2.11 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-4-sch10', description: 'Tubo Schedule 4" SCH 10 (114.30mm x 3.05mm) (DI 108.20mm)', weight: (114.30 - 3.05) * 3.05 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-4-sch40', description: 'Tubo Schedule 4" SCH 40 (114.30mm x 6.02mm) (DI 102.26mm)', weight: (114.30 - 6.02) * 6.02 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-5-sch5', description: 'Tubo Schedule 5" SCH 5 (141.30mm x 2.77mm) (DI 135.76mm)', weight: (141.30 - 2.77) * 2.77 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-5-sch10', description: 'Tubo Schedule 5" SCH 10 (141.30mm x 3.40mm) (DI 134.50mm)', weight: (141.30 - 3.40) * 3.40 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-5-sch40', description: 'Tubo Schedule 5" SCH 40 (141.30mm x 6.55mm) (DI 128.20mm)', weight: (141.30 - 6.55) * 6.55 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-6-sch5', description: 'Tubo Schedule 6" SCH 5 (168.28mm x 2.77mm) (DI 162.74mm)', weight: (168.28 - 2.77) * 2.77 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-6-sch10', description: 'Tubo Schedule 6" SCH 10 (168.28mm x 3.40mm) (DI 161.48mm)', weight: (168.28 - 3.40) * 3.40 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-6-sch40', description: 'Tubo Schedule 6" SCH 40 (168.28mm x 7.11mm) (DI 154.06mm)', weight: (168.28 - 7.11) * 7.11 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-8-sch5', description: 'Tubo Schedule 8" SCH 5 (219.08mm x 2.77mm) (DI 213.54mm)', weight: (219.08 - 2.77) * 2.77 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-8-sch10', description: 'Tubo Schedule 8" SCH 10 (219.08mm x 3.76mm) (DI 211.56mm)', weight: (219.08 - 3.76) * 3.76 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-8-sch40', description: 'Tubo Schedule 8" SCH 40 (219.08mm x 8.18mm) (DI 202.72mm)', weight: (219.08 - 8.18) * 8.18 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-10-sch5', description: 'Tubo Schedule 10" SCH 5 (273.05mm x 3.40mm) (DI 266.25mm)', weight: (273.05 - 3.40) * 3.40 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-10-sch10', description: 'Tubo Schedule 10" SCH 10 (273.05mm x 4.19mm) (DI 264.67mm)', weight: (273.05 - 4.19) * 4.19 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-10-sch40', description: 'Tubo Schedule 10" SCH 40 (273.05mm x 9.27mm) (DI 254.51mm)', weight: (273.05 - 9.27) * 9.27 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-12-sch5', description: 'Tubo Schedule 12" SCH 5 (323.85mm x 3.96mm) (DI 315.93mm)', weight: (323.85 - 3.96) * 3.96 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-12-sch10', description: 'Tubo Schedule 12" SCH 10 (323.85mm x 4.57mm) (DI 314.71mm)', weight: (323.85 - 4.57) * 4.57 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-12-sch40', description: 'Tubo Schedule 12" SCH 40 (323.85mm x 9.53mm) (DI 304.79mm)', weight: (323.85 - 9.53) * 9.53 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-14-sch5', description: 'Tubo Schedule 14" SCH 5 (355.60mm x 3.96mm) (DI 347.68mm)', weight: (355.60 - 3.96) * 3.96 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-14-sch10', description: 'Tubo Schedule 14" SCH 10 (355.60mm x 6.35mm) (DI 342.90mm)', weight: (355.60 - 6.35) * 6.35 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-14-sch40', description: 'Tubo Schedule 14" SCH 40 (355.60mm x 11.13mm) (DI 333.34mm)', weight: (355.60 - 11.13) * 11.13 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-16-sch5', description: 'Tubo Schedule 16" SCH 5 (406.40mm x 4.19mm) (DI 398.02mm)', weight: (406.40 - 4.19) * 4.19 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-16-sch10', description: 'Tubo Schedule 16" SCH 10 (406.40mm x 6.35mm) (DI 393.70mm)', weight: (406.40 - 6.35) * 6.35 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-16-sch40', description: 'Tubo Schedule 16" SCH 40 (406.40mm x 12.70mm) (DI 381.00mm)', weight: (406.40 - 12.70) * 12.70 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-18-sch5', description: 'Tubo Schedule 18" SCH 5 (457.20mm x 4.19mm) (DI 448.82mm)', weight: (457.20 - 4.19) * 4.19 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-18-sch10', description: 'Tubo Schedule 18" SCH 10 (457.20mm x 6.35mm) (DI 444.50mm)', weight: (457.20 - 6.35) * 6.35 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-18-sch40', description: 'Tubo Schedule 18" SCH 40 (457.20mm x 14.27mm) (DI 428.66mm)', weight: (457.20 - 14.27) * 14.27 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-20-sch5', description: 'Tubo Schedule 20" SCH 5 (508.00mm x 4.78mm) (DI 498.44mm)', weight: (508.00 - 4.78) * 4.78 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-20-sch10', description: 'Tubo Schedule 20" SCH 10 (508.00mm x 6.35mm) (DI 495.30mm)', weight: (508.00 - 6.35) * 6.35 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
      { id: 'ts-20-sch40', description: 'Tubo Schedule 20" SCH 40 (508.00mm x 15.09mm) (DI 477.82mm)', weight: (508.00 - 15.09) * 15.09 * TUBE_WEIGHT_CONSTANT, categoryName: 'Tubo Schedule' },
