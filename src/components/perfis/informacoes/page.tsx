    ...
    },
    {
        ...
        content: (
            <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                    <li><StandardLink standardId="nbr8800" />: Norma brasileira para o projeto de estruturas de aço e de estruturas mistas de aço e concreto de edifícios. Ela define os critérios de dimensionamento, resistência, estabilidade e segurança.</li>
                    <li><StandardLink standardId="nbr14762" />: Norma para perfis formados a frio, muito usados em terças e sistemas leves.</li>
                    <li><StandardLink standardId="aics" />: As especificações do AISC são a referência principal nos Estados Unidos e influenciam normas no mundo todo, cobrindo todo o ciclo do projeto.</li>
                </ul>
            </div>
        )
    },
        ...
        content: (
            <div className="space-y-2">
                 ...
                 <div>
                    ...
                    <p className="text-muted-foreground">
                        Verifica-se a resistência ao cisalhamento do parafuso e a resistência à pressão de contato (bearing) no material ao redor do furo. Espaçamentos mínimos e distâncias de borda devem ser respeitados conforme a <StandardLink standardId="nbr8800" />.
                    </p>
                </div>
                 <div>
             ...
             <div className="space-y-2">
                 <p>Para que a laje de concreto e a viga de aço trabalhem juntas (ação composta), são necessários conectores de cisalhamento. Eles transferem a força de cisalhamento horizontal entre os dois materiais.</p>
                  <div>
                    ...
                    <p className="text-muted-foreground">
                       Calcula-se a força de cisalhamento total na interface aço-concreto e divide-se pela resistência de um único conector (Qconector) para obter a quantidade necessária. A norma <StandardLink standardId="nbr14323" /> fornece as diretrizes para este cálculo. A calculadora pode recomendar um número de conectores por metro.
                    </p>
                </div>
            </div>
        )
